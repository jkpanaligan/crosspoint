                              ...
                              <div class="col-sm-8"><!-- col-sm-6 Begin -->
                                  ...
                                  <div class="box"><!-- box Begin -->
                                    ...
                                    <h4 class="modal-title text-center"><?= $row_customer['company_name']; ?></h4>
                                      ...
                                      <form action="change_customer.php" class="form-horizontal" method="post" id="add_product_form"><!-- form-horizontal Begin -->
                                        <input type="hidden" id="customer_id" name="customer_id" value="<?php echo $customer_id; ?>">
                                        <input type="hidden" id="txn_id" name="txn_id" value="<?php echo $txn_id; ?>">
                                        <div class="form-group">
                                          ...
                                          <div class="form-group"><!-- form-group Begin -->
                                               <div class="col-md-2 pull-right"><!-- col-md-7 Begin -->
                                                      ...
                                                      <p class="text-center buttons"><button class="btn btn-primary" onclick="selectcustomer2();return false;"> OK</button></p>

                                                </div><!-- col-md-7 Finish -->

                                                <div class="col-md-2 pull-right"><!-- col-md-7 Begin -->

                                                        <p class="text-center buttons"><a class="btn btn-primary" href="index.php?selectcustomer2=<?php echo $txn_id; ?>"><<< Back</a></p>
