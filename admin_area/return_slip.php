<?php
          ...
          <div class="col-md-2"><!-- col-md-3 Begin -->
           ...
           <div class="col-md-10"><!-- col-md-9 Begin -->
             ...
             <?php
                   ...
                   $rsQuery = $db->query("SELECT * FROM return_slip WHERE id = '{$txn_id}'");
                    $rs = mysqli_fetch_assoc($rsQuery);
                    $id = $rs['id'];
                    $state = $rs['state'];
                    $si_id = $rs['si_id'];
                    $c_id = $rs['customer_id'];
                    ...
                    $siQuery = $db->query("SELECT * FROM sales_invoice WHERE id = '{$si_id}'");
                 ...
                 <div class="col-lg-12"><!-- col-lg-12 begin -->
                     <ol class="breadcrumb"><!-- breadcrumb begin -->
                         <li class="active"><!-- active begin -->
                             ...
                             <i class="fa fa-dashboard"></i> Dashboard / Return Slip

                             <?php if($state != 'Approved'): ?>
                               <a href="index.php?edit_rs=<?php echo $txn_id; ?>&click=1"><span class="btn btn-default"><i class="fa fa-edit"></i></span></a>
                             <?php else: ?>
                             <?php endif; ?>

                             <a href="index.php?view_return_slip"><span class="btn btn-default"><i class="fa fa-list"></i></span></a>
             ...
             <form action="" class="form-horizontal" method="post" enctype="multipart/form-data">
                   ...
                   <table class="table table-condensed table-bordered">
                     <tbody>
                       <tr>
                         ...
                         <td><?=pretty_date($rs['txn_date']);?></td></tr>
                       <tr>
                         <td  align="right">Customer Name:</td>
                         <td><?=$row_customer['company_name'];?></td>
                         <td  align="right">Sales Invoice Number:</td>
                         <td><?=$si['id'];?></td>
                       </tr>
                       <tr>
               ...
               <div class="pull-right">
                 ...
                 <?php else: ?>
                 <?php endif; ?>
                         <a href="index.php?view_return_slip" class="btn btn-large btn-default">Back</a>
              </div>
              </div>
            </form>
  ...
  <?php
      ...
      if(isset($_POST['submit'])){
        ...
        $db->query("UPDATE return_slip SET state = 'Approved' WHERE id = '$dr_id'");
        $_SESSION['success_flash'] = "The Return Slip Has Been Submitted!";
