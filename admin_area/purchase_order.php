      ...
      <?php
            ...
            <div class="col-lg-12"><!-- col-lg-12 begin -->
                <ol class="breadcrumb"><!-- breadcrumb begin -->
                    <li class="active"><!-- active begin -->
                        ...
                        <i class="fa fa-dashboard"></i> Dashboard / Purchase Order
                        <?php if($state != 'Approved'): ?>
                          <a href="index.php?edit_po=<?php echo $txn_id; ?>&click=1"><span class="btn btn-default"><i class="fa fa-edit"></i></span></a>
                        <?php else: ?>
                        <?php endif; ?>

                        <a href="index.php?view_purchase_orders"><span class="btn btn-default"><i class="fa fa-list"></i></span></a>

                        <?php if($state == 'Approved'): ?>
                          <a href="index.php?new_po=<?php echo $txn_id; ?>"><span class="btn btn-default"><i class="fa fa-plus"></i> New DR</span></a>
                        <?php else: ?>
                        <?php endif; ?>
        ...
        <form action="" class="form-horizontal" method="post" enctype="multipart/form-data">
          ...
          <div class="pull-right">
            ...
            <?php else: ?>
            <?php endif; ?>
            <a href="index.php?view_purchase_orders" class="btn btn-large btn-default">Back</a>
          </div>
       </form>
    </div><!-- col-md-9 Finish -->
...
<?php
    ...
    if(isset($_POST['submit'])){
      ...
      $txn_id = sanitize((int)$_GET['txn_id']);
      $db->query("UPDATE purchase_orders SET state = 'Approved' WHERE id = '$txn_id'");
      $_SESSION['success_flash'] = "The Purchase Order Has Been Submitted!";
