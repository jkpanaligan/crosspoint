<?php
          ...
          <div class="col-md-2"><!-- col-md-3 Begin -->
           ...
           <div class="col-md-10"><!-- col-md-9 Begin -->
             ...
             <?php
                 ...
                 $drQuery = $db->query("SELECT * FROM delivery_receipt WHERE id = '{$txn_id}'");
                 ...
                 <div class="col-lg-12"><!-- col-lg-12 begin -->
                     <ol class="breadcrumb"><!-- breadcrumb begin -->
                         <li class="active"><!-- active begin -->
                             ...
                             <i class="fa fa-dashboard"></i> Dashboard / Delivery Receipt

                             <?php if($state != 'Approved'): ?>
                               <a href="index.php?edit_dr=<?php echo $txn_id; ?>&click=1"><span class="btn btn-default"><i class="fa fa-edit"></i></span></a>
                             <?php else: ?>
                             <?php endif; ?>

                             <a href="index.php?view_delivery_receipt"><span class="btn btn-default"><i class="fa fa-list"></i></span></a>
             ...
             <form action="" class="form-horizontal" method="post" enctype="multipart/form-data">
               ...
               <div class="pull-right">
                 ...
                 <?php else: ?>
                 <?php endif; ?>
                         <a href="index.php?view_delivery_receipt" class="btn btn-large btn-default">Back</a>
              </div>
              </div>
            </form>
  ...
  <?php
      ...
      if(isset($_POST['submit'])){
        ...
        $db->query("UPDATE delivery_receipt SET state = 'Approved' WHERE id = '$dr_id'");
        $_SESSION['success_flash'] = "The Delivery Receipt Has Been Submitted!";
